                ...
                <div className="d-flex pt-5 bottom-border">
                    ...
                    <div className="bottom-border pb-5">
                        ...
                        <div className="d-flex justify-content-around flex-wrap">
                            ...
                            <img className="screengrab-img pt-5" src={modal} alt="bookworm read books page"/>
                        </div>   
                    </div>
                    <div>
                        <div className="bottom-border pb-5">
                            <h3 className="pt-5 pb-5 orange-underline">Presentation Time!</h3>
                            <div className="d-flex">
                                <img src={present} alt="me presenting my project" />
